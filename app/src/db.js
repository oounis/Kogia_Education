const KEY="coreon_db_v4"
const MONTHS=["Sep","Oct","Nov","Déc","Jan","Fév","Mar","Avr","Mai","Juin"]
export const FEE_MONTHS=MONTHS
// Tunisian école primaire — 6 niveaux
export const GRADES=["1ère année","2ème année","3ème année","4ème année","5ème année","6ème année"]
function seed(){
  const classes=[{id:"c5a",name:"5ème A",grade:"5ème année"},{id:"c6a",name:"6ème A",grade:"6ème année"}]
  const S=(id,first,last,cls,parent,extra={})=>({id,name:`${first} ${last}`,initials:first[0]+last[0],classId:cls,parentId:parent,
    ...
    guardianPhone:extra.guardianPhone||"+216 20 111 111",medical:extra.medical||"Aucune",allergies:extra.allergies||"Aucune",
    emergencyName:extra.emergencyName||"Tuteur",emergencyPhone:extra.emergencyPhone||"+216 20 222 222"})
  const students=[
    ...
    S("s10","Aziz","Hammami","c5a",null,{gender:"Garçon"}),S("s11","Salma","Ferchichi","c6a",null,{gender:"Fille"}),
    S("s12","Wassim","Oueslati","c6a",null,{gender:"Garçon"}),
  ]
  const teachers=[
  ...
  const incidents=[{id:"inc1",at:Date.now()-86400000,by:"Dali Brahmi",studentId:"s4",type:"Santé",title:"Élève malade",body:"Karim avait mal à la tête pendant la récréation. Envoyé à l'infirmerie.",severity:"medium",status:"open"}]
  ...
  const homework=[{id:"hw1",at:Date.now()-7200000,by:"t1",classId:"c5a",subject:"Mathématiques",title:"Exercices 3.1 à 3.4",due:"2026-06-28",details:"Résoudre tous les problèmes, montrer les étapes."},{id:"hw2",at:Date.now()-90000000,by:"t2",classId:"c5a",subject:"Éveil scientifique",title:"Schéma de la cellule",due:"2026-06-27",details:"Dessiner + légender."}]
  const events=[{id:"e1",date:"2026-06-29",title:"Réunion parents–enseignants",type:"Réunion",desc:"Tous les niveaux, 09:00–12:00."},{id:"e2",date:"2026-07-02",title:"Fête de fin d'année",type:"Événement",desc:"Spectacle des élèves."},{id:"e3",date:"2026-07-05",title:"Début des examens",type:"Examen",desc:"Voir le calendrier."}]
  const exams=[{id:"x1",class:"5ème A",subject:"Mathématiques",date:"2026-07-05",total:100},{id:"x2",class:"5ème A",subject:"Éveil scientifique",date:"2026-07-07",total:100},{id:"x3",class:"6ème A",subject:"Mathématiques",date:"2026-07-06",total:100}]
  ...
  const notifications=[{id:"n1",to:"u_admin",role:null,kind:"request",title:"Nouvelle demande d'attestation",body:"Othman Ounis a demandé une attestation de salaire.",at:Date.now()-3600000,read:false,link:"/app/requests"},{id:"n2",to:"u_admin",role:null,kind:"incident",title:"Incident signalé",body:"Dali Brahmi a signalé : Élève malade (Karim).",at:Date.now()-86400000,read:false,link:"/app/incidents"}]
